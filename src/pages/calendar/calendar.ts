...
export class CalendarPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController, private calendar: Calendar) {
  ...
  addEventToCalendar() {
    this.navCtrl.push(CalendarEventPage);
  }
